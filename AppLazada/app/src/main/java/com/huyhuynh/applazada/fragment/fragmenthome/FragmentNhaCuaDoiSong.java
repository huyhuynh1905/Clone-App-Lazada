...
public class FragmentNhaCuaDoiSong extends Fragment implements FragmenDienTuView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_home_nhacuadoisong,container,false);
        init(view);
