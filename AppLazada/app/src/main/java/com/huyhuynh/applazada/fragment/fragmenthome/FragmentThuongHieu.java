...
public class FragmentThuongHieu extends Fragment implements FragmenDienTuView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_home_thuonghieu,container,false);
        init(view);
