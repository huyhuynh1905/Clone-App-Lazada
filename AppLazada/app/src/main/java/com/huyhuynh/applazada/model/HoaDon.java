...
public class HoaDon {
    ...
    public HoaDon(int mahd, String ngaymua, String ngaygiao, String trangthai, String tennguoinhan,
                  String sodt, String diachi, int chuyenkhoan, String machuyenkhoan) {
        this.mahd = mahd;
