...
public class NhanVienDTO {
    ...
    public NhanVienDTO(String tennv, String email, String matkhau, boolean nhanemail) {
        this.tennv = tennv;
        this.email = email;
    ...
    public NhanVienDTO(int manv, String tennv, String tendn, String email, String matkhau, String diachi
            , String ngaysinh, String sodt, String gioitinh, String cmnd
            , boolean nhanemail, int loaiNhanVien) {
        this.manv = manv;
        this.tennv = tennv;
        this.tendn = tendn;
        this.email = email;
